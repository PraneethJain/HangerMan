...
while True:
    ...
    match status:
        ...
        case 1:
            ...
            attempts_surf=myfont.render(f'Attemps Left: {attempts_left}',False,"Purple")
            screen.blit(main,(center[0]-main.get_width()/2,center[1]-main.get_height()/2-50))
            screen.blit(text_surf,(0,0))
            screen.blit(attempts_surf,(screen.get_width()-attempts_surf.get_width(),attempts_surf.get_height()/2))
            man_image=man_images[attempts-attempts_left]
            screen.blit(man_image,(center[0]-man_image.get_width()/2-25,center[1]+50))
